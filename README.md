...
# 📖 Database diagram for a clinic <a name="about-project"></a>

**Database diagram for a clinic** is a relational database interpreted and implemented from a database diagram.
...
### Setup
* git clone https://github.com/seyioyemade/database-diagram-based.git
* cd database-diagram-based
...
### Usage
- step 1: interprete clinic diagram
...
Feel free to check the [issues page](https://github.com/seyioyemade/database-diagram-based/issues).
